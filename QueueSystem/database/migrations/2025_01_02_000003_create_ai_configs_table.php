...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('ai_configs', function (Blueprint $table) {
            $table->id();
            $table->string('provider'); // openai, claude, deepseek, gemini, groq, etc.
            ...
            $table->longText('code_generation_prompt')->nullable();
            $table->json('allowed_permissions')->nullable(); // Which user roles can use this model
            $table->timestamps();
